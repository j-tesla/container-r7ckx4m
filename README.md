...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-r7ckx4m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-r7ckx4m.containers.anotherwebservice.com/
...
```
git clone git@github.com:j-tesla/container-r7ckx4m.git
cd container-r7ckx4m
```
...
```
docker attach container-r7ckx4m
```
